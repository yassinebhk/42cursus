...
enum e_redirtype { r_output = 1, r_append = 2, r_input = 3, r_heredoc = 4 };
...
enum e_access_mode { e_F_OK = 0, e__OK = 4, e_W_OK = 2, e_X_OK = 1 };
 ...
 * @return The status
 */
int process_command(t_node *head, char *line, t_lists *lists, int status);
