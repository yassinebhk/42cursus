...
/*   Updated: 2024/08/18 20:56:52 by ybouhaik         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		char *old_dir)
{
	...
	new_rel_dir = ft_strjoin(getcwd(NULL, 0), ft_strjoin("/", new_dir));
	...
	{
		update_dirs_env(env, old_dir, ft_strdup(new_rel_dir));
		update_dirs_env(exp, old_dir, ft_strdup(new_rel_dir));
	}
	return (free(new_rel_dir), 0);
}
