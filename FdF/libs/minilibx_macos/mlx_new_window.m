...
// 0: no button, 1: left, 2: right, 3: other
...
// mlx_expose_hook(mlx_ptr->win_list, mlx_expose, mlx_ptr) // mlx_expose is the function to call when expose event occurs
// expose_hook is called when the window is displayed or resized
...
// mlx_key_hook(mlx_ptr->win_list, mlx_key, mlx_ptr) // mlx_key is the function to call when a key is pressed
...
// mlx_mouse_hook(mlx_ptr->win_list, mlx_mouse, mlx_ptr) // mlx_mouse is the function to call when a mouse button is pressed
...
// mlx_hook(mlx_ptr->win_list, 2, 0, mlx_key, mlx_ptr) // mlx_hook is the general hook function
...
// mlx_do_key_autorepeatoff(mlx_ptr) // disable key repeat  (useful for games) 
