...
// The mlx_new_image function creates a new image in memory.
// The image is filled with black. The width and height parameters are the size of the image in pixels.
// The function returns a void * identifier of the image. This identifier is used in the mlx_put_image_to_window function to draw the image in a window.
// The mlx_new_image function returns NULL if the image cannot be created.
...
// The mlx_get_data_addr function returns the address of the image buffer.
...
// The mlx_string_put function is used to draw a string in the window. 
// The string is drawn in the current foreground color. The position of the string is given 
//by the x and y parameters. The string is drawn with the current font. 
//The font can be changed with the mlx_string_put function. The font is a 5x7 bitmap font. 
//The font is defined in the file mlx_new_image.mlx_string_put
